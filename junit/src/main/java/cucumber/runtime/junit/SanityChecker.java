...
public class SanityChecker extends RunListener {
    ...
    @Override
    public void testStarted(Description started) throws Exception {
        spaces();
    ...
    @Override
    public void testFinished(Description ended) throws Exception {
        try {
    ...
    @Override
    public void testIgnored(Description ignored) throws Exception {
        try {
            Description lastStarted = testDescriptions.remove(testDescriptions.size() - 1);
            spaces();
